...
# with max7219 or other similar LED matrix display connected via gpio.
#
...
# max7219 panel(s) setup, resolution, orientation, etc.
#
# Typical max7219 to RPi GPIO wiring:
#   p1 VCC -> RPi p2 5V0
#   p2 GND -> RPi p6 GND
...
#
# For a more flexible version, that uses the more advanced
# luma libraries, and supports a wider variety of devices,
# see led_swarm_luma.py.
#
...
#
# This renderer is specific to the max7219 driver
#
